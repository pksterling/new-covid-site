<div class="home-book-a-test d-flex justify-content-center align-items-center py-5" style="background-image: url('<?php the_field('ot_bg_image'); ?>');">
  <div class="container d-flex flex-column justify-content-center align-items-center py-0 py-md-5">
  <div class="ct-intro px-4">
      <?php the_field('ot_title'); ?>
    </div>
