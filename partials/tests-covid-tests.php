<div class="home-book-a-test d-flex justify-content-center align-items-center py-5" style="background-image: url('<?php the_field('ct_bg_image'); ?>');">
  <div class="container d-flex flex-column justify-content-center align-items-center py-0 py-md-5">
  <div class="ct-intro px-4">
      <?php the_field('ct_title'); ?>
    </div>
    <!-- green -->
    <div id="green-tests" class="bat-products container d-flex flex-row flex-wrap justify-content-center align-items-center pt-0 pt-md-5 w-100">
      <?php  
        $args = array(
            'post_type'      => 'product',
            'product_cat'      => 'green',
        ...
        while ( $loop->have_posts() ) : $loop->the_post();
            ...
            <?php } ?>
            ">
              <div class="product-card-title d-flex justify-content-center align-items-center">
                <?php the_title(); ?>
              </div>
    ...
    <!-- other -->
    <div id="other-tests" class="bat-products container d-flex flex-row flex-wrap justify-content-center align-items-center pt-0 pt-md-5 w-100">
      <?php  
        $args = array(
            'post_type'      => 'product',
            'product_cat'      => 'other',
