<div class="home-book-a-test d-flex justify-content-center align-items-center py-5" style="background-image: url('<?php the_field('onsite_bg_image'); ?>');">
  <div class="container d-flex flex-column justify-content-center align-items-center py-0 py-md-5">
  <div class="ct-intro px-4">
      <?php the_field('onsite_title'); ?>
    </div>
    
  
    <!-- on site -->
    <div id="on-site-tests" class="bat-products container d-flex flex-row flex-wrap justify-content-center align-items-center pt-0 pt-md-5 w-100">
      <?php  
        $args = array(
            'post_type'      => 'product',
            'product_cat'      => 'on-site',
