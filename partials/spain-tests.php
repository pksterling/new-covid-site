...
<div class="home-book-a-test d-flex justify-content-center align-items-center py-5" style="background-image: url('<?php the_field('st_bg_image'); ?>');">
  ...
  <div class="ct-intro px-4">
    ...
    <!-- spain -->
    <div id="st-tests" class="bat-products container d-flex flex-row flex-wrap justify-content-center align-items-center pt-0 pt-md-5 w-100">
      <?php  
        $args = array(
            'post_type'      => 'product',
						'parent' 				 => 'amber',
